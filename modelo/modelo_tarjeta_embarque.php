...
function generarCodAlfanumerico()
{
    $generador_codigoAlfanumerico = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';

    $cod_alfanumerico = substr(str_shuffle($generador_codigoAlfanumerico), 0, 12);

    return $cod_alfanumerico;
