                ...
                foreach ( $vuelos as $vuelo){
                    echo   "<div class='w3-third w3-section w3-border w3-white' style='margin: 1% 1%; width: 31%; padding: 1%'>
                                ...
                                if(isset($_SESSION["logueado"])){
                                    echo "<button class='w3-button w3-block w3-black w3-auto' data-toggle=\"modal\" data-target=\"#myModal\" name='btn-reservar'>Reservar</button>";
                                }
                    echo    "</div>";
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Ingrese Cantidad de Pasajeros</h4>
                        </div>
                        <div class="modal-body">
                            <input type="number" name="cantidad">
                        </div>
                        <a class="modal-footer">
                            <a href="reserva" onclick="javascript:window.location='reserva'" data-dismiss="modal">Confirmar</a>
                        </div>
   ...
   <div id="cantidadDePasajeros" class="w3-modal">
       <div class="w3-modal-content">
           <div class="w3-container">
      <span onclick="abrirModal('cantidadDePasajeros').style.display='none'"
